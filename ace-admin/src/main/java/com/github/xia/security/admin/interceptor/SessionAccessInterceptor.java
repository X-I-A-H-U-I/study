package com.github.xia.security.admin.interceptor;

import com.github.xia.security.admin.rpc.PermissionFeignServer;
import com.github.xia.security.admin.rpc.UserFeignServer;
...
public class SessionAccessInterceptor extends HandlerInterceptorAdapter {
    ...
    @Autowired
    private PermissionFeignServer permissionFeignServer;
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
        ...
        if (request.getSession().getAttribute("permission") == null) {
            UserInfo userInfo = userFeignServer.getUserByUsername(username);
            permissionInfos = permissionFeignServer.getPermissionByUsername(userInfo.getUsername());
